...
public class ReservationController {
	...
	@DeleteMapping
	public ResponseEntity<Void> removeReservation(@RequestBody ReservationCreateDto reservationCreateDto){
		reservationService.removeReservation(reservationCreateDto);
